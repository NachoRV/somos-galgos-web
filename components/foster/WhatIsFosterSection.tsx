...
import { Heart, Home, DollarSign, Smile } from 'lucide-react';

export function WhatIsFosterSection() {
  const t = useTranslations('Foster');

  const benefits = [
    { icon: Heart, text: t('whatIsBenefit1') },
    { icon: Home, text: t('whatIsBenefit2') },
    { icon: DollarSign, text: t('whatIsBenefit3') },
    { icon: Smile, text: t('whatIsBenefit4') },
  ];
