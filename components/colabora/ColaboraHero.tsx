  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center px-4 py-20 bg-gradient-to-br from-[var(--color-primary)] via-[var(--color-accent)] to-[var(--color-secondary)] pt-40">
      <div className="max-w-4xl mx-auto text-center z-10">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 drop-shadow-lg">{t('heroTitle')}</h1>
        <p className="text-xl md:text-2xl text-white/90 mb-10 max-w-2xl mx-auto">{t('heroSubtitle')}</p>
      </div>
    </section>
  );
};
